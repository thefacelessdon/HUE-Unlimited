...
import type { Decision, Output, Organization, DecisionDependency } from "@/lib/supabase/types";
...
export default async function DecisionsPage() {
  ...
  const [{ data: decisionData }, { data: outputData }, { data: orgData }, { data: depData }] = await Promise.all([
    supabase
      .from("decisions")
      .select("*")
